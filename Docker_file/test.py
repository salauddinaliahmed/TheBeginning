...
import time
from dronekit import connect, VehicleMode, LocationGlobalRelative, mavutil, mavlink, Command
...
def arm_and_takeoff(aTargetAltitude):
    ...
    vehicle._master.mav.command_long_send(0, 0, 22, 0, 0, 0, 0, 0, float('NaN'), float('NaN'), aTargetAltitude)
    # cmd = Command(0,0,0, mavutil.mavlink.MAV_FRAME_LOCAL_NED, mavutil.mavlink.MAV_CMD_NAV_TAKEOFF, 0, 1, 0, 0, 0, 0, vehicle.location.local_frame.north, vehicle.location.local_frame.east, -aTargetAltitude)
    # cmds.add(cmd)
    # cmds.upload()
    print ("Message sent")
    # a = vehicle.commands.next
    # print (cmds.upload)
